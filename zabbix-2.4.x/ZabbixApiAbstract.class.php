...
abstract class ZabbixApiAbstract
{
    ...
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method itemvalue.GetItemValues.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function itemvalueGetItemValues($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('itemvalue.GetItemValues', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method itemvalue.getLastValueBy.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function itemvalueGetLastValueBy($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('itemvalue.getLastValueBy', $params, $arrayKeyProperty);
    }
    
    /**
     * @brief   Reqeusts the Zabbix API and returns the response of the API
     *          method itemvalue.getItemListFormat.
     *
     * The $params Array can be used, to pass through params to the Zabbix API.
     * For more informations about this params, check the Zabbix API
     * Documentation.
    ...
    public function itemvalueGetItemListFormat($params=array(), $arrayKeyProperty='')
    {
        // get params array for request
        $params = $this->getRequestParamsArray($params);

        // request
        return $this->request('itemvalue.getItemListFormat', $params, $arrayKeyProperty);
    }
    ...
    public function getItemListFormat($params=array(), $arrayKeyProperty=''){
    	// get params array for request
        $params = $this->getRequestParamsArray($params);
